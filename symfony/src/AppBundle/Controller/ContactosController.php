...
class ContactosController extends Controller {
    ...
    public function consultaGeneralContactoListAction(Request $request) {
         ...
         * Params:   *           
         * ***************************************************** */
        $query = $em->createQuery('SELECT c.trato, c.tipoContacto, '
                //. "DATE_SUB(c.fechaIngreso, 0, 'DAY') AS fechaIngreso, DATE_SUB(c.fechaFinalizacion, 0, 'DAY') AS fechaFinalizacion, "
                . "c.nombre1Contacto, c.nombre2Contacto, c.apellido1Contacto, c.apellido2Contacto, "
        ...
        $count_rest = count($contactosFind);
