 ...
 * @version 1.0                                                                * 
 *******************************************************************************/
class DocumentosUnidadCorrespondenciaController extends Controller{
     ...
     *     Informacion.                                                        * 
     * Path: /documentos-unidad-correspondencia/subir-documentos-comunicacion
     ***************************************************************************/
    public function newAction(Request $request) {
        ...
        if($checkToken == true){
            ...
            if ($json != null) {
                ...
                $cod_correspondencia_entrada  = ($params->cod_correspondencia_det != null) ? $params->cod_correspondencia_det : null ;                
                ...
                if($cod_documento != null && $desc_documento != null){
                    ...
                    $documentoNew = new TblDocumentosUnidadCorrespondencia();                    
                    ...
                    $documentoNew->setHoraIngreso($hora_ingreso);                    
                    ...
                    //Instanciamos de la Clase TblCorrespondenciaEntrante                 
                    $correspondencia = $em->getRepository("BackendBundle:TblCorrespondenciaEntrante")->findOneBy(                            
                        array(
                           "codCorrespondenciaEntrante" => $cod_correspondencia_entrada
                        ));               
                    ...
                    $isset_doc_cod = $em->getRepository("BackendBundle:TblDocumentosUnidadCorrespondencia")->findOneBy(
                        array(
            ...
            $data = array(
                "status" => "error",                
                "code" => "400",                
                "msg" => "Autorizacion de Token no valida, tu sesion ha caducado inicia una nueva para continuar !!"                
            );
        }        
