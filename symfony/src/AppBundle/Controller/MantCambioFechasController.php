               ...
               $cod_comunicacion     = ($params->codCorrespondencia != null) ? $params->codCorrespondencia : null ;                             
                ...
                if( $cod_comunicacion != null ){
                    ...
                    $query = $em->createQuery('SELECT DISTINCT enc.idCorrespondenciaEnc, enc.codCorrespondenciaEnc, enc.codReferenciaSreci, '
                                    ...
                                    . 'tbi.idInstitucion, tbi.descInstitucion, tbti.idTipoInstitucion, tbti.descTipoInstitucion, tbpa.idPais, tbpa.descPais '
                                    ...
                                    . 'INNER JOIN BackendBundle:TblInstituciones tbi WITH tbi.idInstitucion = enc.idInstitucion '
                                    . 'INNER JOIN BackendBundle:TblTipoInstitucion tbti WITH tbti.idTipoInstitucion = tbi.idTipoInstitucion '
                                    . 'INNER JOIN BackendBundle:TblPais tbpa WITH tbpa.idPais = tbi.idPais '
