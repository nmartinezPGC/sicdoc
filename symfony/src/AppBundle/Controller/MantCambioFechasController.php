                            ...
                            */
                            ...
                            if( $count > 5 ) {
                                ...
                                $data = array(
                                    "status" => "error",                                
                                    "code"   => 400, 
                                    "msg"    => "Ya son: " . $count . " las veces que has solicitado el cambio.",
                                    "data"   => $count
                                ); 
                            }else{                                
                                ...
                                //Instanciamos de la Clase TblUsuarios *********
                                $usuarioSolicitud = $em->getRepository("BackendBundle:TblUsuarios")->findOneBy(
                                    array(
                                       "idUsuario" => $cod_usuario                         
                                    ));                    
                                $soliciutdCambioFechaNew->setIdUsuarioCreacion( $usuarioSolicitud ); //Set de Id de Usuario Solicitud
