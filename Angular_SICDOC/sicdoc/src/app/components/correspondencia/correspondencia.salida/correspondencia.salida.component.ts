...
import { SalidaCorrespondenciaService } from '../../../services/correspondencia/salida.correspondencia.service'; //Servico de Ingreso de Correspondencia
...
import { SalidaCorrespondenciaModel } from '../../../models/correspondencia/salida.correspondencia/salida.correspondencia.model'; // Modelo a Utilizar
...
@Component({
  selector: 'app-correspondencia.salida',
  templateUrl: './correspondencia.salida.component.html',
  styleUrls: ['./correspondencia.salida.component.css'],
  providers: [ ListasComunesService, SalidaCorrespondenciaService, UploadService ]
})
export class CorrespondenciaSalidaComponent implements OnInit {
  // Propiedades de la Clase
  // Datos de la Vetana
  public titulo:string = "Salida Correspondencia";
  ...
  public _SalidaCorrespondenciaModel: SalidaCorrespondenciaModel;
  ...
  ****************************************************************************/
  constructor( private _listasComunes: ListasComunesService,
               private _salidaCorrespondenciaService: SalidaCorrespondenciaService,
       ...
       this.urlConfigLocal = this._salidaCorrespondenciaService.url;
       this.urlResourseLocal = this._salidaCorrespondenciaService.urlResourses;
  ...
  *************************************************/
  ngOnInit() {
    ...
    this._SalidaCorrespondenciaModel.pdfDocumento = "";
  ...
  ******************************************************/
   ...
   ******************************************************/
   getlistaInstituciones() {
       this.params.idPais = this._SalidaCorrespondenciaModel.idPais;
       this.params.idTipoInstitucion = this._SalidaCorrespondenciaModel.idTipoInstitucion;
       //Llamar al metodo, de Login para Obtener la Identidad
    ...
    ******************************************************/
    createNewFileInput( nameDoc ){
     ...
     this._SalidaCorrespondenciaModel.pdfDocumento = this.JsonOutgetListaDocumentosNew;
    ...
    ******************************************************/
    ...
    fileChangeEvent(fileInput: any){
      ...
      this._SalidaCorrespondenciaModel.pdfDocumento = this.codigoSec;
    ...
    ******************************************************/
    getlistaOficosIngresados() {
      ...
      this._salidaCorrespondenciaService.documentosIngresados( this.paramsIdTipoComSend ).subscribe(
          response => {
            // login successful so redirect to return url
            if(response.status == "error"){
              //Mensaje de alerta del error en cuestion
    ...
    ******************************************************/
    getlistaOficosRecibidos() {
      ...
      this._salidaCorrespondenciaService.documentosRecibidos( this.paramsIdTipoComSend ).subscribe(
          response => {
            // login successful so redirect to return url
            if(response.status == "error"){
              //Mensaje de alerta del error en cuestion
