...
import { ReporteResumidoService } from '../../../../services/consultas/reporte.resumido.service'; //Servico Reporte resumido
...
@Component({
  ...
  providers: [ ListasComunesService, ReporteResumidoService]
})
export class ReporteResumidoComponent implements OnInit {

  public fechaHoy:Date = new Date();
  public titulo = "Reporte Resumido";
  ...
  public _ModelReporteResumido: ReporteGeneral;
  ...
  constructor( private _listasComunes: ListasComunesService,
               private _reporteResumidoService: ReporteResumidoService,
      ...
      $ (function () {
        $('#example').DataTable( {
            ...
            "columnDefs": [
                  ...
                  { // Columna de Descripción de la Institucion
                      "targets": [ 3 ],
                      "visible": false,
                      "searchable": true
                  }
  ...
  ******************************************************/
  ngOnInit() {
    ...
    this._ModelReporteResumido = new ReporteGeneral( null, null, 0, 0,
                                [], [], [],
                                null, null);
  ...
  ******************************************************/
  onSubmit(forma:NgForm){
      ...
      console.log( this._ModelReporteResumido );
      this._reporteResumidoService.comunicacionFind( this._ModelReporteResumido).subscribe(
        response => {
  ...
  ******************************************************/
  protected onSelectedDireccion( item: CompleterItem ) {
    ...
    this._ModelReporteResumido.idDireccion = parseInt(this.selectedDireccion);
  } // FIN | FND-00004
  ...
  ******************************************************/
  protected onSelectedFuncionarios( item: CompleterItem ) {
    ...
    this._ModelReporteResumido.idFuncionarioAsignado = parseInt(this.selectedFuncionario);
  } // FIN | FND-00004.1
