...
@Injectable()
export class ReporteResumidoService {
  ...
  *****************************************************/
  comunicacionFind( correspondencia_to_find ){
    ...
    return this._http.post(this.url + "/reportes/reporte-resumido", params, { headers:headers }).map( res => res.json());
  } // FIN : FND-00003
